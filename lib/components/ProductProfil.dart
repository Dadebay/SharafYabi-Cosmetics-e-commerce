                                ...
                                children: [
                                  RichText(
                                    ...
                                    text: TextSpan(children: <TextSpan>[
                                      TextSpan(text: "$priceMine", style: const TextStyle(fontFamily: montserratSemiBold, fontSize: 24, color: Colors.black)),
                        ...
                        children: [
                          ...
                          gridViewMine(
                            ...
                            parametrs: {
                              ...
                              "category_id": "${[snapshot.data!.categoryId]}",
                            },
                            removeText: true,
                          ),
                        ],
  ...
  Padding specText({String? text1, String? text2}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(text1!, style: TextStyle(color: Colors.grey[600], fontFamily: montserratMedium, fontSize: 17)),
          Expanded(
              child: Text(
            '.' * 100,
            maxLines: 1,
          ...
          Text(text2!, style: const TextStyle(color: Colors.black, fontFamily: montserratMedium, fontSize: 17)),
        ],
      ),
    );
  }
